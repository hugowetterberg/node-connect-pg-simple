...
* **checkExpiry** - if you want to provide your own logic for when expired sessions should be purged you can supply a `function(action)` here. `action` will be one of "get" and "set" so that you can decide whether you want to purge on write, read, or both.
